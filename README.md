...
<picture title="Bloom" width="250">
	<source align="right" media="(prefers-color-scheme: dark)" srcset="assets/bloom-logo.png" alt="Bloom logo" width="250" />
	<source align="right" media="(prefers-color-scheme: light)" srcset="assets/bloom-logo.png" alt="Bloom logo" width="250" />
...
> [!IMPORTANT]
> <details>
> <summary>Before building the app, you need to change the audio player plugin (with something else) because it's **private**.<br>Open here for more info.</summary>
> 
> ---
> 
